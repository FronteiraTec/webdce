            ...
            <div class="container">
                <div id="mainSlider" class="carousel slider" data-ride="carousel">
                    ...
                    <a href="#mainSlider" class="carousel-control-prev" role="button" data-slide="prev"
                        onclick="$('#mainSlider').carousel('prev')">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a href="#mainSlider" class="carousel-control-next" role="button" data-slide="next"
                        onclick="$('#mainSlider').carousel('next')">
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-4 col-md-12 img-noticia">
                                    <img class="card-img-top" src="imagens/exemplo_noticia1.jpg"
                                        alt="Imagem capa da noticia">
                                </div>
                                <div class="col-8 col-md-12 info-noticia">
                                    <h5 class="card-title card-noticia-title">
                                        <a href="#" class="card-title card-noticia-title" data-toggle="tooltip"
                                            title="Titulo da Noticia aqui">Titulo da Noticia aqui</a>
                                    </h5>
                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-8 col-md-12 info-noticia">
                                    <h5 class="card-title card-noticia-title">
                                        <a href="#" class="card-title card-noticia-title" data-toggle="tooltip"
                                            title="Noticia com um titulo grande para testar o alinhamento">Noticia com
                                            um titulo grande para testar o alinhamento</a>
                                    </h5>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-grupos">
                                ...
                                <p class="card-text"><strong>Descrição:</strong> Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Sed tempus orci id augue aliquam dignissim in nec justo.
                                    Pellentesque luctus eu velit nec ullamcorper. In ultricies augue sed dictum
                                    vehicula. Duis vehicula nulla sit amet tortor lobortis dignissim.</p>
